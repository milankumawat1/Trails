...
function Plane() {
  ...
  return (
    <HelmetProvider>
      <Helmet>
       <link rel="preload" href={map} as="image"></link>
       <link rel="preload" href={bluebg} as="image"></link>
       <link rel="preload" href={text} as="image"></link>
       <link rel="preload" href={text} as="image"></link>
       <link rel="preload" href={visatext} as="image"></link>
      </Helmet>
