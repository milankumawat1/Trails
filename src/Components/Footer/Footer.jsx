  ...
  return (
    <div className='footer'>
      ...
      <div className="trail-desc flex">
        ...
        <video src={video} className="footer-vid" preload="auto" autoPlay loop></video>
      ...
      <div className="footer-main-content flex">
        ...
        <div className="column flex">
          ...
          <a href='tel:+919599253573'><span><MdOutlinePhone /></span>&nbsp;+919599253573</a>
        ...
        <div className="column flex">
          ...
          <div>
            ...
            <a href='https://www.instagram.com/yolotripss?igsh=MWliZ3R4Y28wb3AxZg%3D%3D&utm_source=qr'>
